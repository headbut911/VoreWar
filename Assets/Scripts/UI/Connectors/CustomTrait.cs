...
public class CustomTrait : MonoBehaviour
{
    ...
    public InputField ExpRequired;
    public InputField ExpGain;
    public InputField ExpGainFromVore;
    public InputField ExpGainFromAbsorption;
    public InputField PassiveHeal;
    public InputField CapacityMult;
    public InputField OutgoingChanceToEscape;
    public InputField OutgoingMeleeDamage;
    public InputField OutgoingRangedDamage;
    public InputField OutgoingMagicDamage;
    public InputField OutgoingDigestionRate;
    public InputField OutgoingAbsorptionRate;
    public InputField OutgoingNutrition;
    public InputField OutgoingManaAbsorbHundreths;
    public InputField OutgoingMeleeShift;
    public InputField OutgoingRangedShift;
    public InputField OutgoingMagicShift;
    public InputField OutgoingVoreOddsMult;
    public InputField OutgoingGrowthRate;
    public InputField OutgoingCritRateShift;
    public InputField OutgoingCritDamageMult;
    public InputField OutgoingGrazeRateShift;
    public InputField OutgoingGrazeDamageMult;
    public InputField IncomingChanceToEscape;
    public InputField IncomingMeleeDamage;
    public InputField IncomingRangedDamage;
    public InputField IncomingMagicDamage;
    public InputField IncomingDigestionRate;
    public InputField IncomingAbsorptionRate;
    public InputField IncomingNutrition;
    public InputField IncomingManaAbsorbHundreths;
    public InputField IncomingMeleeShift;
    public InputField IncomingRangedShift;
    public InputField IncomingMagicShift;
    public InputField IncomingVoreOddsMult;
    public InputField IncomingGrowthRate;
    public InputField IncomingCritRateShift;
    public InputField IncomingCritDamageMult;
    public InputField IncomingGrazeRateShift;
    public InputField IncomingGrazeDamageMult;
    public InputField FlatHitReduction;
    public InputField SpeedLossFromWeightMultiplier;
    public InputField DodgeLossFromWeightMultiplier;
    public InputField BulkMultiplier;
    public InputField SpeedMultiplier;
    public InputField MinSpeed;
    public InputField SpeedBonus;
    public InputField MeleeAttacks;
    public InputField RangedAttacks;
    public InputField VoreAttacks;
    public InputField SpellAttacks;
    public InputField ManaMultiplier;
    public InputField StaminaMultiplier;
    public InputField VoreMinimumOdds;
    public InputField TurnCanFlee;
    public InputField DigestionImmunityTurns;
    public InputField HealthRegen;
    public InputField ManaRegen;
    public InputField OnLevelUpBonusToAllStats;
    public InputField OnLevelUpBonusToGiveToTwoRandomStats;
    public Toggle OnLevelUpAllowAnyStat;
    public InputField Scale;
    public InputField StatMult;
    public InputField VirtualDexMult;
    public InputField VirtualStrMult;
    public InputField FireDamageTaken;
    public InputField GrowthDecayRate;
    public InputField SightRangeBoost;
