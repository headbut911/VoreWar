...
public class ItemRepository
{
    ...
    public ItemRepository()
    {
        ...
        specialItems = new List<Item>()
        {
            ...
            new Weapon(name:"Xelhilde's Zweihänder", description:"A Mondfeld forged zweihänder. It's edge seems to shimer like the moon.", cost:4, graphic:0, damage:8, range:1, accuracyModifier: 1.4f, lockedItem:true),
        };
