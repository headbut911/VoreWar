...
static class StoredLogTexts
{
    ...
    internal static void InitializeLists()
    {
        ...
        SwallowMessages = new List<EventString>()
        {
            ...
            new EventString((i) => $"<b>{i.Unit.Name}</b> {GetRandomStringFrom("swallows", "gulps down", "vores", "devours")} <b>{i.Target.Name}</b> and says \"You've been a bad dog! I hope you enjoy your stay in there because I know I will!\" as she resumes panting adorably.",
            actorRace: Race.Xelhilde, targetRace: Race.Dogs, priority: 9, conditional: s => !s.Target.IsDead && s.Target.Side != s.Unit.Side),
            ...
            actorRace: Race.Xelhilde, priority: 9, conditional: s => TargetHumanoid(s) && !s.Target.IsDead && s.Target.Side != s.Unit.Side),
